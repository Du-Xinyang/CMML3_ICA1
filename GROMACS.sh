...
# Run GROMACS
(1) Generate topology file, position restraint file and the post-processed structure file   #Choose amber99sb-ildn
...
(8) Energy analysis  # 10 0
    gmx energy -f em.edr -o potential.xvg 
(9) Equilibration with solvent, Applying a position restraining force
    gmx grompp -f nvt.mdp -c em.gro -r em.gro -p topol.top -o nvt.tpr
(10) NVT equilibration
    gmx mdrun -deffnm nvt -nb gpu -ntomp 8
(11) Analysis of the temperature progression, using energy  #16 0
    gmx energy -f nvt.edr -o temperature.xvg 
(12) NPT Equilibration 
    gmx grompp -f npt.mdp -c nvt.gro -r nvt.gro -t nvt.cpt -p topol.top -o npt.tpr
(13) NPT equilibration
    gmx mdrun -deffnm npt -nb gpu -ntomp 8
(14) Analysis of pressure progression, using energy   #24 0
    gmx energy -f npt.edr -o density.xvg 
(15) Analysis of pressure progression, using energy    # 18 0
    gmx energy -f npt.edr -o pressure.xvg
(16) Release the position restraints and run production MD
...
# MD results analysis
(1) To account for any periodicity in the system   # Choose "Protein", choose "System" as output
    gmx trjconv -s md_300K_50ns.tpr -f md_300K_50ns.xtc -o md_300K_50ns_noPBC.xtc -pbc mol -center     
(2) Structural stability analysis. Relative to the structure present in the minimized, equilibrated system.     # Choose "Protein", choose "System" as output
    gmx rms -s md_300K_50ns.tpr -f md_300K_50ns_noPBC.xtc -o rmsd_300K_50ns.xvg -tu ns   
(3) Structural stability analysis. Relative to the crystal structure.    #Choose "Backbone", choose "System" as output
    gmx rms -s em.tpr -f md_300K_50ns_noPBC.xtc -o rmsd_xtal.xvg      
(4) The radius of gyration     # Choose "Protein"
    gmx gyrate -s md_300K_50ns.tpr -f md_300K_50ns_noPBC.xtc -o gyrate_300K_50ns.xvg    
(5) Extract the last frame structure (assuming a total simulation duration of 50 ns)     #Choose "Protein"
    gmx trjconv -s md_300K_50ns.tpr -f md_300K_50ns_noPBC.xtc -o final_300K.pdb -dump 50000      
(6) Extract structures within a specific time range (such as the last 10 ns)     #Choose "Protein"
